...
**Progress:** 10/19 done · 0 active · 0 blocked · generated 2026-07-07 08:37 UTC @ `1262e15`
...
| `spike/frame-alignment-check` | Verify 'frame alignment is exact': phase-1 GPU-decode vs SAM CPU re-decode both use seek_mode=approximate and tests only check index-length; add checksum/hash verification + open-GOP/VFR fixtures, or reuse one decode path | ⬜ pending | 2026-07-07-review-fixes | — | — |
